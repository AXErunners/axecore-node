...
var axecorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = axecorenode.version;
  var create = axecorenode.scaffold.create;
  var add = axecorenode.scaffold.add;
  var start = axecorenode.scaffold.start;
  var remove = axecorenode.scaffold.remove;
  var callMethod = axecorenode.scaffold.callMethod;
  var findConfig = axecorenode.scaffold.findConfig;
  var defaultConfig = axecorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Axe database directory')
  ...
  program
    ...
    .option('-d, --daemon', 'Make axecore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `axecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ axecore-node add wallet-service');
      console.log('    $ axecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ axecore-node remove wallet-service');
      console.log('    $ axecore-node remove insight-api');
      console.log();
    });
