...
/**
 * Will remove a service from axecore-node.json
...
/**
 * Will remove the Node.js service and from the axecore-node configuration.
  ...
  async.eachSeries(
    ...
    function(service, next) {
      ...
      removeService(configPath, service, function(err) {
        ...
        // remove service to axecore-node.json
        removeConfig(axecoreConfigPath, service, next);
      });
    }, done
  );
}
