...
module.exports.cli.axecore = require('./lib/cli/axecore');
module.exports.cli.axecored = require('./lib/cli/axecored');

module.exports.lib = require('@axerunners/axecore-lib');
